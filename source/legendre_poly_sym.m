function [ cx, cdx, cd2x ] = legendre_poly_sym ( nDeg )

%*****************************************************************************80
%
%% LEGENDRE_POLY_SYM returnsthe symbolic Legendre polynomials P(N)(X).
%
%  Discussion:
%
%    P(N)(1) = 1.
...
syms x
  ...
  for i = 2 : nDeg
    ...
    cdx(i+1) = ( ( 2 * i - 1 ) * ( cx(i) + x * cdx(i) ) ...
               - (     i - 1 ) *   cdx(i-1)               ) ...
               / (     i     );
 
    cd2x(i+1)= ( ( 2 * i - 1 ) * ( 2 * cdx(i) + x * cd2x(i) ) ...
               - (     i - 1 ) *   cd2x(i-1)               ) ...
               / (     i     );
