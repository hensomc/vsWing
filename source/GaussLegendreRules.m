function [GP,GW]=GaussLegendreRules(n)

%% function [GP,GW]=gaussLegendre(n)

% Program to get the quadrature pointsand weight for Gauss-Legendre 
% Quadrature rule
...
% Calculating the Pn(x)Legendre Polynomial Using recursive relationship
